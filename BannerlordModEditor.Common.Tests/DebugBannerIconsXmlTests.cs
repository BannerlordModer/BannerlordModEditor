...
{
    public class DebugBannerIconsXmlTests
    {
        [Fact]
        public void Debug_BannerIcons_RoundTrip_StructuralEquality()
        {
            ...
            File.WriteAllText("serialized.xml", xml2);
            
            // 结构化对比
            Assert.True(diff.IsStructurallyEqual, "XML structures should be equal");
        }
    }
}