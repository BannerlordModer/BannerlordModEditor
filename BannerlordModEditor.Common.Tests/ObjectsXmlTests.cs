...
namespace BannerlordModEditor.Common.Tests
{
    ...
    {
        [Fact]
        public void Objects_LoadAndSave_ShouldBeLogicallyIdentical()
        {
            // Arrange
            var solutionRoot = FindSolutionRoot();
            var xmlPath = Path.Combine(solutionRoot, "BannerlordModEditor.Common.Tests", "TestData", "objects.xml");
            ...
            {
                objects = (Objects)serializer.Deserialize(reader)!;
            }
            ...
            Assert.NotNull(objects.Item);
            Assert.NotNull(objects.PlayerCharacter);
            
            // 检查所有必要元素都存在
            Assert.True(objects.Item.Object.Count > 0, "Should have at least one item object");
            Assert.True(objects.PlayerCharacter.Object.Count > 0, "Should have at least one player character");
        }
