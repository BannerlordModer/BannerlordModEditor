...
namespace BannerlordModEditor.Common.Models.DTO.Game
{
    ...
    public class MonstersDTO
    {
        ...
        /// </summary>
        [XmlElement("Monster")]
        public List<MonsterDTO> MonsterList { get; set; } = new List<MonsterDTO>();
    }
