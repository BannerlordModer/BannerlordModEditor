...
{
    /// <summary>
    /// 动作集合配置的数据传输对象 - movement_sets.xml
    /// 基于MovementSets Data模型，用于DO/DTO架构模式转换
    /// </summary>
    [XmlRoot("movement_sets")]
    public class MovementSetsDTO
    {
        /// <summary>
        /// 动作集合列表
        /// </summary>
        [XmlElement("movement_set")]
        public List<MovementSetDTO> MovementSetList { get; set; } = new List<MovementSetDTO>();
