...
{
    [XmlRoot("base")]
    public class DecalTexturesWorldmap
    {
        [XmlAttribute("type")]
        public string Type { get; set; }

        [XmlElement("decal_textures")]
        public DecalTexturesWorldmapDecalTextures DecalTextures { get; set; }

        public bool ShouldSerializeType() => !string.IsNullOrEmpty(Type);
        public bool ShouldSerializeDecalTextures() => DecalTextures != null;
    }

    public class DecalTexturesWorldmapDecalTextures
    {
        [XmlElement("decal_texture")]
        public List<DecalTexturesWorldmapDecalTexture> DecalTextureList { get; set; }

        public bool ShouldSerializeDecalTextureList() => DecalTextureList != null && DecalTextureList.Count > 0;
    }

    public class DecalTexturesWorldmapDecalTexture
    {
        [XmlAttribute("name")]
