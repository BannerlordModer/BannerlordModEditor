...
- **文档语言**: 所有文档必须使用中文编写，严禁使用英文
- **文件名称**: 所有文件名必须使用中文，清晰描述文档内容
- **文档标题**: 文档内标题必须使用中文
- **文档内容**: 文档内容必须使用中文编写
- **技术术语**: 保持技术术语的英文原名，但必须提供中文注释
- **代码注释**: 代码示例中的注释必须使用中文
- **目录名称**: 目录名称建议使用中文，如技术分析、项目计划等
...
### 命名规范
- **文件名必须使用中文**，清晰描述文档内容
- **禁止使用英文文件名**，特殊情况需团队讨论决定
- 避免特殊字符，使用连字符或下划线分隔
- 保持命名一致性，遵循项目约定
- 文件名应该直观反映文档内容和用途
- 示例：`需求规格.md`、`架构设计文档.md`、`测试指南.md`
